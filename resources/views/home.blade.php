    ...
    <div id="scene" style="
        ...
        <div class="figures">
            <div class="figures-day" id="scene-left" style="transform: translate(0px, 0px); transform-style: preserve-3d; backface-visibility: hidden; pointer-events: none;">
                ...
                <div data-depth="{{ $loop->iteration * 0.3 }}" class="figures-part figures-part-left" style="transform: translate3d(0px, 0px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: {{ $loop->first ? 'relative' : 'absolute' }}; display: block; left: 0px; top: 0px; z-index: {{ 10-$loop->iteration }};">
            ...
            <div class="figures-night" id="scene-right" style="transform: translate(0px, 0px); transform-style: preserve-3d; backface-visibility: hidden; pointer-events: none;">
                ...
                <div data-depth="{{ $loop->iteration * 0.3 }}" class="figures-part figures-part-right" style="transform: translate3d(0px, 0px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: {{ $loop->first ? 'relative' : 'absolute' }}; display: block; left: 0px; top: 0px; z-index: {{ 10-$loop->iteration }};">
                    <img src="{{ asset('storage/' . $figure->img_path) }}" alt="">
                </div>
                @endforeach
            </div>
